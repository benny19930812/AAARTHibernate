...
@WebServlet(name = "DeleteByIdDispatcherAction", urlPatterns = "/DeleteByIdDispatcherAction")
public class DeleteByIdDispatcherAction extends HttpServlet {
	...
	private void processAction(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<ShopBean> shopsList = sbs.selectById(id);
			...
			String ccShopsSerachMsg = "查無此商店編號";
			request.setAttribute("ccShopsSerachMsg", ccShopsSerachMsg); // 回傳錯誤訊息
		}
		// 設定回傳屬性值
		RequestDispatcher rd = request.getRequestDispatcher("/_03_cultural_and_creative_shops_cms/delete_confirm.jsp");
