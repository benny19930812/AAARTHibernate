...
@WebServlet(name = "UpdateByIdDispatcherAction", urlPatterns = "/UpdateByIdDispatcherAction")
public class UpdateByIdDispatcherAction extends HttpServlet {
	...
	private void processAction(HttpServletRequest request, HttpServletResponse response)
		...
		// 設定回傳屬性值
		RequestDispatcher rd = request.getRequestDispatcher("/_03_cultural_and_creative_shops_cms/update_confirm.jsp");
